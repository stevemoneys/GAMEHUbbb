(() => {
    const claimTopButton = document.getElementById("claimDailyBtn");
    ...
    function refreshMeta() {
        ...
        claimTopButton.disabled = daily.alreadyClaimed;
    ...
    claimTopButton.addEventListener("click", handleClaim);

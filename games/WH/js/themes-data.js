(() => {
  ...
  window.WHPowerUps = [
    { id: "second-chance", name: "Second Chance", icon: "\u{1F504}", description: "Play 2 cards in one turn.", price: 380 },
    { id: "peek-ai", name: "Peek AI Cards", icon: "\u{1F50D}", description: "See one AI card briefly.", price: 320 },
    { id: "shield", name: "Shield", icon: "\u{1F6E1}", description: "Blocks Pick 2 / Pick 3 / Market.", price: 460 },
    { id: "magnet-draw", name: "Magnet Draw", icon: "\u{1F9F2}", description: "Draws guaranteed valid card.", price: 420 },
    { id: "destroy-card", name: "Destroy Card", icon: "\u{1F4A5}", description: "Remove one bad card.", price: 520 },

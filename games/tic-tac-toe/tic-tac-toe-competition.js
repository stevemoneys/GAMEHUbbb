...
(function competitionLoop(global) {
  ...
  function screens(id) { ["menu", "reverse", "levels", "avatars", "symbolSelect", "game", "learning", "competition", "experiment", "gauntlet"].forEach((screen) => $(screen)?.classList.toggle("active", screen === id)); }
